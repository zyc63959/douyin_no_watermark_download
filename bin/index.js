...
class Scraper {
    ...
    constructor() {
        ...
        this.douyinApiHeaders = {
            ...
            'cookie': 'sid_guard=542e381ec9bab09668a1b5bef26e0b8c%7C1735819744%7C5184001%7CMon%2C+03-Mar-2025+12%3A09%3A05+GMT;'
            // 其他请求头
        };
    }
    ...
    */
    ...
    async getDouyinNoWatermarkVideo(videoData) {
     ...
     /**
     * @description parser no watermark video and image url
     * @param {object} videoData 
     * @returns {object}
     */
